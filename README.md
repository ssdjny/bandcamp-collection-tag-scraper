...
Scrape + filter your Bandcamp collection into a .txt list (by tags)
Build a skimmable HTML page that embeds each album/track player + lets you filter/search
...
3) Target tags
const TARGET_TAGS = [ 'breaks', 'breakbeat', 'ukg', '2-step', 'dubstep' ];
